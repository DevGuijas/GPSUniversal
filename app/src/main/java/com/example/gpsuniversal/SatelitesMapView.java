...
public class SatelitesMapView extends View {
    ...
    public SatelitesMapView(Context context) {
        super(context);
        init(null, 0);
    }

    public SatelitesMapView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SatelitesMapView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Drawable getConstellationIcon(int constellationType) {
        switch (constellationType) {
            case GnssStatus.CONSTELLATION_GALILEO:
                return getResources().getDrawable(R.drawable.brasil);
            case GnssStatus.CONSTELLATION_GLONASS:
                return getResources().getDrawable(R.drawable.chile);
            case GnssStatus.CONSTELLATION_GPS:
                return getResources().getDrawable(R.drawable.dinamarca);
            case GnssStatus.CONSTELLATION_BEIDOU:
                return getResources().getDrawable(R.drawable.noruega);
            case GnssStatus.CONSTELLATION_QZSS:
                return getResources().getDrawable(R.drawable.suecia);
            default:
                return null;
        }
    }
