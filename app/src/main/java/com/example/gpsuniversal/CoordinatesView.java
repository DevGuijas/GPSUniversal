...
public class CoordinatesView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Lembrar de ajustar
        canvas.drawText("Latitude: " + getFormatedDegrees(mLatitude), 20, 80, textPaint);
        canvas.drawText("Longitude: " + getFormatedDegrees(mLongitude), 20, 110, textPaint);
    }
    ...
    private String getFormatedDegrees(double degrees) {
        if (degrees != 0) {
            switch (mType) {
                ...
                case GRAUS_POR_MINUTOS:
                    return degreesToDMM(degrees);
                case GRAUS_POR_MINUTOS_POR_SEGUNDOS:
